...
{
	//std::cout<<"Inside the constructor1 of GNormalDistributionsTransform"<<std::endl;
...
{
	//std::cout<<"Inside the constructor2 of GNormalDistributionsTransform"<<std::endl;
...
GNormalDistributionsTransform::~GNormalDistributionsTransform()
{
	//std::cout<<"Inside the Destructor of GNormalDistributionsTransform"<<std::endl;
...
{
	//std::cout<<"Inside computeTransformation of ndt_gpu"<<std::endl;
